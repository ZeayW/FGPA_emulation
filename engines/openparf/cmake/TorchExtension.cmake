...
set(
  OPENPARF_ENABLE_CUDA
  "AUTO"
  CACHE STRING
  "Build PyTorch operators with CUDA: AUTO, ON, or OFF"
)
set_property(
  CACHE OPENPARF_ENABLE_CUDA
  PROPERTY STRINGS AUTO ON OFF
)
if(NOT OPENPARF_ENABLE_CUDA STREQUAL "AUTO")
  if(OPENPARF_ENABLE_CUDA)
    set(TORCH_ENABLE_CUDA 1)
  else()
    set(TORCH_ENABLE_CUDA 0)
  endif()
endif()
